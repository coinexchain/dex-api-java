...
public class InlineResponse20057 {
  @SerializedName("data")
  private List<BancorTrade> data = null;

  @SerializedName("timesid")
  private List<Long> timesid = null;

  public InlineResponse20057 data(List<BancorTrade> data) {
    this.data = data;
    return this;
  }

  public InlineResponse20057 addDataItem(BancorTrade dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public List<BancorTrade> getData() {
    return data;
  }

  public void setData(List<BancorTrade> data) {
    this.data = data;
  }

  public InlineResponse20057 timesid(List<Long> timesid) {
    this.timesid = timesid;
    return this;
  }

  public InlineResponse20057 addTimesidItem(Long timesidItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.data, inlineResponse20057.data) &&
        Objects.equals(this.timesid, inlineResponse20057.timesid);
  }
