...
public class BaseReq {
   ...
   * @return from
  **/
  @Schema(example = "coinex1y5kdxnzn2tfwayyntf2n28q8q2s80mcul852ke", description = "Sender address or Keybase name to generate a transaction")
   ...
   * @return memo
  **/
  @Schema(example = "Sent with example memo", description = "")
   ...
   * @return chainId
  **/
  @Schema(example = "coinex-chain-1", description = "")
  ...
  **/
   ...
   * @return gas
  **/
  @Schema(example = "200000", description = "")
  ...
  **/
   ...
   * @return simulate
  **/
  @Schema(example = "false", description = "Estimate gas for a transaction (cannot be used in conjunction with generate_only)")
